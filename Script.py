...
ಕೆಳಗೆ ಕಾಣುವ ನಮ್ಮ BACKUP ಚಾನೆಲ್ಗೆ ಜಾಯಿನ್ ಆಗಿ ಮತ್ತು Try again ಬಟನ್ ಕ್ಲಿಕ್ ಮಾಡಿ ಫೈಲ್ ಪಡೆಯಿರಿ.</b>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/JISSHU_BOTS'>Jisshu Bots &lt;/&gt;</a></b></blockquote>"""
    ...
    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : ℍℙ ℝ𝕒𝕛
‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/MR_HP_Raj'>ӇƤ Ʀƛʆ</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  :  ᴡᴇʙ
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>@masterprajwalraj@fam</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
 
⛽️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan

🏷️ <a href='https://telegram.dog/HP_Raj_MOVIES'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰ</a>
...
/movie_update_on - Movie Update on</blockquote></b>"""
    ...
    SOURCE_TXT = """<b>
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<blockquote><a href="https://t.me/HP_Raj_MOVIES">HP</a></blockquote>

ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @HP_Raj_MOVIES
</b>"""
